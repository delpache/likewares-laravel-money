...
class Provider extends ServiceProvider
{
    ...
    {
        Blade::component('money', \Likewares\Money\View\Components\Money::class);
        Blade::component('currency', \Likewares\Money\View\Components\Currency::class);
    }
}
